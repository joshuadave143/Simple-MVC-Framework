 ...
 *
 *
 * @package    propel.generator.SimpleMVC.Base
 */
abstract class Post implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\SimpleMVC\\Map\\PostTableMap';
    ...
    /**
     * Initializes internal state of SimpleMVC\Base\Post object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : PostTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = PostTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SimpleMVC\\Post'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \SimpleMVC\Post (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SimpleMVC\Post Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
