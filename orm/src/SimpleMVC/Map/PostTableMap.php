...
class PostTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'SimpleMVC.Map.PostTableMap';
     ...
     */
    public const OM_CLASS = '\\SimpleMVC\\Post';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'SimpleMVC.Post';
     ...
     */
    public const COL_CONTENT = 'post.content';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Title', 'Content', ],
        self::TYPE_CAMELNAME     => ['id', 'title', 'content', ],
        self::TYPE_COLNAME       => [PostTableMap::COL_ID, PostTableMap::COL_TITLE, PostTableMap::COL_CONTENT, ],
        self::TYPE_FIELDNAME     => ['ID', 'title', 'content', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Title' => 1, 'Content' => 2, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'title' => 1, 'content' => 2, ],
        self::TYPE_COLNAME       => [PostTableMap::COL_ID => 0, PostTableMap::COL_TITLE => 1, PostTableMap::COL_CONTENT => 2, ],
        self::TYPE_FIELDNAME     => ['ID' => 0, 'title' => 1, 'content' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'content' => 'CONTENT',
        'post.content' => 'CONTENT',
        'PostTableMap::COL_CONTENT' => 'CONTENT',
        'COL_CONTENT' => 'CONTENT',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName('\\SimpleMVC\\Post');
        $this->setPackage('SimpleMVC');
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(PostTableMap::COL_CONTENT);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \SimpleMVC\Post) { // it's a model object
